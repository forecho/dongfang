...
<h2 style="margin:12px 10px 10px 7px " >信息列表</h2> 
<div class="td" style="margin:0px 0px 0px 7px;">
  <?php 
  	echo form_open('orient/info_list', "target='mainList'");
  ...
  <table width="99%" cellspacing="0" cellpadding="0" border="0" style="font-size:12px; text-align: center;border:none;margin-bottom:10px;">
  	<tr height="30">
    	<td style="border:none;" width="5%" align="right">类型：</td>
        <td style="border:none;" width="5%" align="left"><select name="c_id"><option value="请选择类型">请选择类型</option>
            <?php
    	...
    	<td style="border:none;" width="5%" align="right">标题：</td>
  ...
  <?php echo form_close();?>
  <iframe src="<?php echo base_url('orient/info_list/'.$what); ?>" width="99%" height="600" frameborder="0" name="mainList"></iframe>
</div>
</div>
</body>
</html>