...
<h2 style="margin:12px 10px 10px 7px " >友情链接列表</h2> 
<div class="td" style="margin:0px 0px 0px 7px;">
  <form name="form" method="post" action="<?php echo base_url('orient/del_link'); ?>" id="form">
...
?>
    <tr height="30">
      ...
      <td><?php echo anchor('orient/link_edit/'.$info->id, '编辑', "target='main'").' | '.anchor('orient/delo_link/'.$info->id, '删除', array('onclick'=>"return queren()"))?></td>
    </tr>
<?php 
	endforeach;
?>
