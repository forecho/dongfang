...
<h2 style="margin:12px 10px 10px 7px " >首页滚动图片管理</h2> 
...
?>
    <tr>
      ...
      <td><?php echo anchor('orient/photo_edit/'.$info->id, '编辑', "target='main'").' | '.anchor('orient/delo_photo/'.$info->id, '删除', array('onclick'=>"return queren()"))?></td>
    </tr>
<?php 
	endforeach;
?>
