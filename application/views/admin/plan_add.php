...
<?php 
	echo form_open('orient/plan_add');
?> 
	<div style="width:900px; height:650px; border:#D2D2D2 solid 1px; margin-left:110px; font-size:12px;">
    	<div style="margin-left:50px; margin-top:30px;">
    	<p style="margin-left:22px;">标题：<input type="text" name="title" value="<?php echo set_value('title'); ?>" class="input"/>&nbsp;&nbsp;<?php echo form_error('title'); ?></p>
        <p style="margin-left:22px;">内容：&nbsp;&nbsp;<?php echo form_error('content'); ?></p>
        <div style="margin-left:60px;"><textarea id="content" name="content" style="width:670px;height:320px;visibility:hidden;"><?php echo set_value('content'); ?></textarea></div>
        <p style="margin-left:22px;">分&nbsp;&nbsp;类：<select name="c_id">
            <?php
        ...
        <p style="margin-left:22px;">关键词：<input name="keywords" type="text"  size="60"/></p>
        <p style="margin-left:22px;">描&nbsp;&nbsp;述：<input name="description" type="text"  size="60"/></p>
        <p style="margin-left:22px;">排&nbsp;&nbsp;序：<input name="sort" type="text" value="0" size="5" /></p>
