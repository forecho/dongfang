...
<h2 style="margin:12px 10px 10px 7px " >合作伙伴修改</h2>
<?php 
	echo form_open_multipart('orient/partner_edit');
	echo form_hidden('id', $edit->id);
?> 
	<div style="width:900px; height:240px; border:#D2D2D2 solid 1px; margin-left:110px; font-size:12px;">
        ...
        <p style="margin-left:24px;">尺寸：<span class="error">200*70</span>&nbsp;&nbsp;图片格式：<span class="error">只限.jpg</span></p>
