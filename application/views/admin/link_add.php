...
<h2 style="margin:12px 10px 10px 7px " >友情链接信息添加</h2>
<?php 
	echo form_open('orient/link_add');
?> 
	<div style="width:900px; height:200px; border:#D2D2D2 solid 1px; margin-left:110px; font-size:12px;">
        ...
        <p style="margin-left:24px;">地址：<input type="text" name="url" value="<?php echo set_value('url'); ?>" class="input" />&nbsp;&nbsp;<span class="error">请填写完整的（带）http://的链接地址</span>&nbsp;&nbsp;<?php echo form_error('url'); ?></p>
        <p style="margin-left:24px;">排序：<input type="text" name="sort" value="0" size="2" /></p>
        <p style="margin-left:200px;"><input type="submit" value="提交内容" style="cursor:pointer;" /></p>
        </div>
    </div>
<?php 
	echo form_close();
