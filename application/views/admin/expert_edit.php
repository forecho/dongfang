...
<h2 style="margin:12px 10px 10px 7px " >专家团队修改</h2>
<?php 
	echo form_open_multipart('orient/expert_edit');
...
?> 
	<div style="width:900px; height:560px; border:#D2D2D2 solid 1px; margin-left:110px; font-size:12px;">
    	...
    	<p style="margin-left:24px;">姓名：<input type="text" name="name" value="<?php echo $edit->name; ?>" class="input" />&nbsp;&nbsp;<?php echo form_error('name'); ?></p>
    	...
    	<p style="margin-left:24px;">Blog：<input type="text" name="blog" value="<?php echo $edit->blog; ?>" class="input" />&nbsp;&nbsp;<?php echo form_error('blog'); ?></p>
