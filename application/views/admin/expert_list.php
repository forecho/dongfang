...
<h2 style="margin:12px 10px 10px 7px " >专家团队列表</h2> 
<div class="td" style="margin:0px 0px 0px 7px;">
  <form name="form" method="post" action="<?php echo base_url('orient/del_expert'); ?>" id="form">
...
?>
    <tr height="100">
      ...
      <td><img src="<?php echo base_url($info->img);?>" width="80" /></td>
      <td><?php echo $info->name; ?></td>
      <td style="padding:5px;" align="left"><?php echo mb_substr(strip_tags($info->content), 0, 100).'......'; ?></td>
      <td><?php echo $info->sort; ?></td>
      <td><?php echo anchor('orient/expert_edit/'.$info->id, '编辑', "target='main'").' | '.anchor('orient/delo_expert/'.$info->id, '删除', array('onclick'=>"return queren()"))?></td>
    </tr>
<?php 
	endforeach;
?>
