...
<h2 style="margin:12px 10px 10px 7px " >公告管理</h2> 
<div class="td" style="margin:0px 0px 0px 7px;">
  <form name="form" method="post" action="<?php echo base_url('chihiro/del_notices'); ?>" id="form">
...
?>
    <tr>
      ...
      <td><?php echo anchor('chihiro/notice_edit/'.$info->id, '编辑', "target='main'").' | '.anchor('chihiro/delo_notice/'.$info->id, '删除', array('onclick'=>"return queren()"))?></td>
    </tr>
<?php 
	endforeach;
?>
    <tr>
      <td colspan="6"><input value="全选"  onclick="CheckAll(this.form)" type="button" name="chkall" style="cursor:pointer"></input>
