...
<h2 style="margin:12px 10px 10px 7px " >首页滚动图片添加</h2>
<?php 
	echo form_open_multipart('orient/photo_add');
?> 
	<div style="width:900px; height:270px; border:#D2D2D2 solid 1px; margin-left:110px; font-size:12px;">
    	<div style="margin-left:100px; margin-top:30px;">
		<p>图片地址：<input name='file' type="file">&nbsp;&nbsp;（图片尺寸：960*400）&nbsp;&nbsp;图片格式：.jpg&nbsp;&nbsp;<span class="error"><?php echo $error['error']; ?></span>&nbsp;&nbsp;<span class="error"><?php echo $error['type']; ?></span>&nbsp;&nbsp;<span class="error"><?php echo $error['size']; ?></span></p>
