...
<h2 style="margin:12px 10px 10px 7px " >公告添加</h2>
<?php 
	echo form_open('chihiro/notice_add');
?> 
	<div style="width:900px; height:535px; border:#D2D2D2 solid 1px; margin-left:110px; font-size:12px;">
    	<div style="margin-left:50px; margin-top:30px;">
    	<p>公告标题：<input type="text" name="title" value="<?php echo set_value('title'); ?>" class="input"/>&nbsp;&nbsp;<?php echo form_error('title'); ?></p>
        <p>公告内容：&nbsp;&nbsp;<?php echo form_error('content'); ?></p>
        <div style="margin-left:60px;"><textarea id="content" name="content" style="width:700px;height:320px;visibility:hidden;"><?php echo set_value('content'); ?></textarea></div>
