...
<h2 style="margin:12px 10px 10px 7px " >分类修改</h2>
<?php 
	echo form_open('orient/class_edit');
	echo form_hidden('what', $what);
	echo form_hidden('cid', $edit->cid);
?> 
	<div style="width:900px; height:180px; border:#D2D2D2 solid 1px; margin-left:110px; font-size:12px;">
    	<div style="margin-left:200px; margin-top:30px;">
    	<p>分类名称：<input type="text" name="name" value="<?php echo $edit->name; ?>" class="input"/>&nbsp;&nbsp;<?php echo form_error('name'); ?></p>
